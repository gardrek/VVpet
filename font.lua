...
function getFontLine(data, line_num)
  local index = data - 31
  local pixel = 0
  if font4x6[index][2] & 1 == 1 then line_num = line_num - 1 end
  if line_num == 0 then
  ...
  elseif line_num == 2 then
    -- Split over 2 bytes
    return ((font4x6[index][1] & 0x03) << 2) | (font4x6[index][2] & 0x02)
  elseif line_num == 3 then
    pixel = font4x6[index][2] >> 4
  elseif line_num == 4 then
    pixel = font4x6[index][2] >> 1
  end
  return pixel & 0xE
end
